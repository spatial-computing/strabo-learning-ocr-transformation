    ...
    public class TextRecognitionWorker
    {
        ...
        public void Apply(string inputPath, string outputPath, string TesseractResultsJSONFileName, double top, double left, double bottom, double right)
        {
            Apply(inputPath, outputPath, TesseractResultsJSONFileName, StraboParameters.language, StraboParameters.dictionaryFilePath, StraboParameters.dictionaryExactMatchStringLength,
                Double.Parse(MapServerParameters.BBOXW), Double.Parse(MapServerParameters.BBOXN), MapServerParameters.xscale, MapServerParameters.yscale, MapServerParameters.srid, top, left, bottom, right, StraboParameters.elasticsearch);
        }
        public void Apply(string inputPath, string outputPath, string TesseractResultsJSONFileName, string lng, string dictionaryFilePath, int dictionaryExactMatchStringLength, double bbxW, double bbxN, double xscale, double yscale, string srid, double top, double left, double bottom, double right, bool elasticsearch)
        {
            try
            {
                string tessPath = "";
